 ...
 * @author LKHorosheva
 * @since 0.0.1
 * объект данного класса всегда должен содежать только одну колонку
 *             т.е массив  HashMap<SKeyForColumn, DColumn> columns должен быть из одного элемента
 *             и эту колонку  будем отображать как выпадающий список заполенный данными из БД
 */
public class DColumnBuilderComboBoxDB extends IColumnBuilder implements Serializable {
