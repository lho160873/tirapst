...
import com.extjs.gxt.ui.client.widget.AriaSupport;
 ...
 * @since 0.0.1
 */
public class DColumnBuilderMulti extends IColumnBuilder implements Serializable {
    ...
    protected Boolean isReadOnly = true; //открываем таблицу для выбора в режиме только на чтение
    ...
    public Boolean getIsViewOnly() {
     ...
     public void setIsReadOnly(Boolean isViewOnly) {
