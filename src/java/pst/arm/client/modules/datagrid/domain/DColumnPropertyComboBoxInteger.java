 ...
 */
public class DColumnPropertyComboBoxInteger extends IColumnPropertyComboBox<Integer,String> implements Serializable{
    ...
    public DColumnPropertyComboBoxInteger() {
        super();
