 ...
 */
public class DColumnPropertyComboBoxNullNotNull extends IColumnPropertyComboBox<Integer,String> implements Serializable{
    ...
    public DColumnPropertyComboBoxNullNotNull() {
        super();
    ...
    public String getFormatFromValue(Integer value) {
        ...
        for (DListValIntegerString val : list) {
            if ((value != null) && (val.getKey().intValue()) == 1) {
                return val.getVal();
            }
            else if ((value == null) && (val.getKey().intValue()) == 0) {
                return val.getVal();
            }
        }
        return null;
