 ...
 * @since 0.0.1
 */
public class DColumnPropertyDateField extends IColumnProperty<Date, Date> implements Serializable {
    ...
    public DColumnPropertyDateField() {
    ...
    public Date getValueFromFormat(Date valueFormat) {
        ...
        return (Date) DateTimeFormat.getFormat(format).parse(DateTimeFormat.getFormat(format).format(valueFormat));
    }
