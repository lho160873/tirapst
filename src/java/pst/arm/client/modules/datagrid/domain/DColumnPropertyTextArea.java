 ...
 * @since 0.0.1
 */
public class DColumnPropertyTextArea extends DColumnPropertyTextField implements Serializable {
    protected Boolean isNotFirstEmpty = Boolean.FALSE;
    private Integer fieldHeight = null;
    public DColumnPropertyTextArea() {
        super();
    }
    ...
    public void setFieldHeight(Integer h) {
        fieldHeight = h;
    }
