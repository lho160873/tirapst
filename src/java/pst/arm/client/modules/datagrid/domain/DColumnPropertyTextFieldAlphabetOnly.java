 ...
 * @since 0.0.1
 */
public class DColumnPropertyTextFieldAlphabetOnly extends IColumnProperty<String,String> implements Serializable {
 
    protected int maxLength = Integer.MAX_VALUE;  
    protected int minLength = 0;
    
    public DColumnPropertyTextFieldAlphabetOnly() {
        format = "";
   ...
   @Override
    ...
    public Field createField(Boolean isNotNull) //простой построитель для полей ввода
    {
        ...
        //field.setRegex(".+@.+\\.[a-z]+");
         field.setValidator(new VTypeValidator(VType.ALPHABETNOTEMPTY));
