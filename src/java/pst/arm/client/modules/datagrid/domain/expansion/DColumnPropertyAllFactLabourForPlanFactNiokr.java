 ...
 */
public class DColumnPropertyAllFactLabourForPlanFactNiokr extends DColumnPropertyTextField {
    @Override
...
SKeyForColumn dflDivDrlKey = new SKeyForColumn("MAIN", "ALL_FACT_LABOUR");
...
row.getRows().get(new SKeyForColumn("MAIN:ALL_FACT_LABOUR_COLOR")).setVal(qtip);
return html;
}
return "";
}
