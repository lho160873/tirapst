 ...
 */
public class DColumnPropertyFactLabourDop1ForPlanFactNiokr extends DColumnPropertyTextField {
    @Override
...
SKeyForColumn dflDivDrlKey0 = new SKeyForColumn("MAIN", "PLAN_LABOUR_DOP1");
SKeyForColumn dflDivDrlKey = new SKeyForColumn("MAIN", "FACT_LABOUR_DOP1");
...
row.getRows().get(new SKeyForColumn("MAIN:FACT_LABOUR_DOP1_COLOR")).setVal(qtip);
return html;
}
return "";
}
