 ...
 * @author wesStyle
 */
public class DataGridEditWindowDhJobPlan extends DomainEditPanelSimple<DDataGrid>{
    String customHeader = "";
    ...
    public DataGridEditWindowDhJobPlan(DDataGrid domain, DTable table, EditState state, EWindowType windowType)
    {
    ...
    public DataGridEditWindowDhJobPlan(DDataGrid domain, DTable table, EditState state, EWindowType windowType, DCondition cnd) {
        super(domain, state, windowType);
        editDomain();
        setTable(table);
    ...
    public DataGridEditWindowDhJobPlan(DDataGrid domain, DTable table, EditState state, EWindowType windowType, DCondition cnd, String customHeader) {
        super(domain, state, windowType);
    ...
    protected void save(final Listener actionListener) {
        ...
        curr.setSeconds(0);
            ...
            String proc = "exec [dbo].[DH_JOB_PLAN] '" + sqlDate + "'," + oId + "," + intId;
