 ...
 * @author n
 */
public class DataGridPanelExecutorsNew extends DataGridPanel {

    public DataGridPanelExecutorsNew(DTable table, String tn, DCondition cnd) {
        super(table, tn, cnd);
    }

    public DataGridPanelExecutorsNew(DTable table, String tn) {
        super(table, tn);
    }

    public DataGridPanelExecutorsNew(String tableName) {
        super(tableName);
    }

    public DataGridPanelExecutorsNew(String tableName, SRelationInfo relationInfo) {
    ...
    public DataGridPanelExecutorsNew(DTable table, String tableName, SRelationInfo relationInfo) {
