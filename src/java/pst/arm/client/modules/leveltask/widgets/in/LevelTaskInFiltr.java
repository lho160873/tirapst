 ...
 * @since 0.0.1
 */
public class LevelTaskInFiltr extends PanelFiltrSimple {

    private CheckBox cbIsAll;
    private DateField dfBegDate, dfEndDate;
    private TextField<String> tfUserNameFrom;
    private DGComboBox<Integer> cbTaskName, cbTaskState;

    public LevelTaskInFiltr(LevelTaskInPanel resPanel) {
        super(resPanel);
    }   
    ...
    protected void search() {
        ...
        if ( tfUserNameFrom.getValue()!= null ) {
            resPanel.getCondition().getSearches().put("userNameFrom", tfUserNameFrom.getValue());
        }
