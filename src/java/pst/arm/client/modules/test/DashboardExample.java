package pst.arm.client.modules.test;
...
import pst.arm.client.common.test.FormattedNumericFilter;
import pst.arm.client.common.test.model.Data;
import pst.arm.client.common.test.model.RadarData;
import pst.arm.client.common.test.Example.Detail;
  ...
  public Widget asWidget() {
    if (panel == null) {
      ...
      eastLayoutData.setMargins(new Margins(5, 0, 0, 0));
            ...
            //panel.setLayoutData(new FlowLayoutContainer());
