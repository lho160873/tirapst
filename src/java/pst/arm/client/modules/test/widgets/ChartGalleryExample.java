...
import pst.arm.client.modules.test.widgets.examples.ChartModelExample;
import pst.arm.client.modules.test.widgets.examples.GalleryChartModel;
//import pst.arm.client.modules.test.widgets.examples.Examples;
...
public class ChartGalleryExample extends LayoutContainer {
  ...
  private ChartModelExample example = new RadarChartExample();//LineChartExample();//HorizontalChartExample();//BarGlassChartExample();//RadarChartExample();//new AreaChartExample();
    ...
    public ChartModel getChartModel(int segments) {
      ...
      bchart.addChartListener(new ChartListener()
      {
           @Override
            ...
            @Override
            public void handleEvent(ChartEvent e) {
                MessageBox.info("", "handleEvent", null);
            }
      });
  ...
  class LineChartExample implements ChartModelExample {
    public ChartModel getChartModel(int segments) {
      ...
      YAxis ya = new YAxis();
        ...
        xa.setRange(0, 4);
        xa.setSteps(1);
        xa.setLabels("1", "2", "3", "4");
        xa.setTickHeight(5);        
        cm.setXAxis(xa);
      
       LineChart line = new LineChart();
         line.addValues(4,3,4,3);
