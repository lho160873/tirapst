 ...
 */
@Controller
@RequestMapping("/secure/datagridchoicenormavsalary.htm")

public class DataGridChoiceNormAvSalaryController extends ModuleController {

    private String moduleName = "datagridchoicenormavsalary";
