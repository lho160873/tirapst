 ...
 */
@Controller
@RequestMapping("/secure/datagridcontractstat.htm")
public class DataGridContractStatController extends ModuleController {

    
    private String moduleName = "datagridcontractstat";
