 ...
 */
@Controller
@RequestMapping("/secure/datagridcontracttype.htm")
public class DataGridContractTypeController extends ModuleController {

    
    private String moduleName = "datagridcontracttype";
