 ...
 */
@Controller
@RequestMapping("/secure/datagridcontracts.htm")
public class DataGridContractsController extends ModuleController {

    
    private String moduleName = "datagridcontracts";
