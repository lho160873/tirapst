 ...
 */
@Controller
@RequestMapping("/secure/datagriddepworkload.htm")
public class DataGridDepWorkloadController extends ModuleController {

    
    private String moduleName = "datagriddepworkload";
