 ...
 */
@Controller
@RequestMapping("/secure/datagriddepartforprocess.htm")
public class DataGridDepartForProcessController extends ModuleController {

    
    private String moduleName = "datagriddepartforprocess";
