 ...
 */
@Controller
@RequestMapping("/secure/datagriddepartpost.htm")
public class DataGridDepartPostController extends ModuleController {

    
    private String moduleName = "datagriddepartpost";
