 ...
 */
@Controller
@RequestMapping("/secure/datagriddeparttype.htm")
public class DataGridDepartTypeController extends ModuleController {

    
    private String moduleName = "datagriddeparttype";
