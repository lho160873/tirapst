 ...
 */
@Controller
@RequestMapping("/secure/datagriddhorderpriboy.htm")
public class DataGridDhOrderPriboy extends ModuleController {

    
    private String moduleName = "datagriddhorderpriboy";
