 ...
 */
@Controller
@RequestMapping("/secure/datagridfacilities.htm")
public class DataGridFacilitiesController extends ModuleController {

    
    private String moduleName = "datagridfacilities";
