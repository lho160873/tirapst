 ...
 */
@Controller
@RequestMapping("/secure/datagridmilitaryrepr.htm")

public class DataGridMilitaryReprController extends ModuleController {
    
    private String moduleName = "datagridmilitaryrepr";
