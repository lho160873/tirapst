 ...
 */
@Controller
@RequestMapping("/secure/datagridnotifopening.htm")
public class DataGridNotifOpeningController extends ModuleController {

    
    private String moduleName = "datagridnotifopening";
