 ...
 */
@Controller
@RequestMapping("/secure/datagridordertype.htm")

public class DataGridOrderTypeController extends ModuleController {

    private String moduleName = "datagridordertype";
