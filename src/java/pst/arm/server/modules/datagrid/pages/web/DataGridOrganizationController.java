 ...
 */
@Controller
@RequestMapping("/secure/datagridorganization.htm")

public class DataGridOrganizationController extends ModuleController {
    
    private String moduleName = "datagridorganization";
