 ...
 */
@Controller
@RequestMapping("/secure/datagridplanniokrimpl.htm")
public class DataGridPlanNiokrImpl extends ModuleController {

    
    private String moduleName = "datagridplanniokrimpl";
