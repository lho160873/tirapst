 ...
 */
@Controller
@RequestMapping("/secure/datagridplanntoyear.htm")
public class DataGridPlanNtoYearController extends ModuleController {

    
    private String moduleName = "datagridplanntoyear";
