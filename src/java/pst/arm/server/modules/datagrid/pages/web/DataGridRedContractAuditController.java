 ...
 */
@Controller
@RequestMapping("/secure/datagridredcontractaudit.htm")

public class DataGridRedContractAuditController extends ModuleController {

    private String moduleName = "datagridredcontractaudit";
