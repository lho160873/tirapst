 ...
 */
@Controller
@RequestMapping("/secure/datagridreddepart1caudit.htm")

public class DataGridRedDepart1cAuditController extends ModuleController {

    private String moduleName = "datagridreddepart1caudit";
