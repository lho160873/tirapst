 ...
 */
@Controller
@RequestMapping("/secure/datagridreddepartaudit.htm")

public class DataGridRedDepartAuditController extends ModuleController {

    private String moduleName = "datagridreddepartaudit";
