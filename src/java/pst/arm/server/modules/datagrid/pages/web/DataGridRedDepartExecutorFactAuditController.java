 ...
 */
@Controller
@RequestMapping("/secure/datagridreddepartexecutorfactaudit.htm")

public class DataGridRedDepartExecutorFactAuditController extends ModuleController {

    private String moduleName = "datagridreddepartexecutorfactaudit";
