 ...
 */
@Controller
@RequestMapping("/secure/datagridreddepartpostaudit.htm")

public class DataGridRedDepartPostAuditController extends ModuleController {

    private String moduleName = "datagridreddepartpostaudit";
