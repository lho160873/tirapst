 ...
 */
@Controller
@RequestMapping("/secure/datagridreddhelaborationofddaudit.htm")

public class DataGridRedDhElaborationOfDdAuditController extends ModuleController {

    private String moduleName = "datagridreddhelaborationofddaudit";
