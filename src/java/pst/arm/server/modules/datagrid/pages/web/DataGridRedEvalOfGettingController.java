 ...
 */
@Controller
@RequestMapping("/secure/datagridredevalofgetting.htm")
public class DataGridRedEvalOfGettingController extends ModuleController {

    
    private String moduleName = "datagridredevalofgetting";
