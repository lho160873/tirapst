 ...
 */
@Controller
@RequestMapping("/secure/datagridredleveltaskaudit.htm")

public class DataGridRedLevelTaskAuditController extends ModuleController {

    private String moduleName = "datagridredleveltaskaudit";
