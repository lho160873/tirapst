 ...
 */
@Controller
@RequestMapping("/secure/datagridrednormavsalaryaudit.htm")

public class DataGridRedNormAvSalaryAuditController  extends ModuleController {

    private String moduleName = "datagridrednormavsalaryaudit";
