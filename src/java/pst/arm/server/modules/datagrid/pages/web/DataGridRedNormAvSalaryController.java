 ...
 */
@Controller
@RequestMapping("/secure/datagridrednormavsalary.htm")

public class DataGridRedNormAvSalaryController extends ModuleController {

    private String moduleName = "datagridrednormavsalary";
