 ...
 */
@Controller
@RequestMapping("/secure/datagridrednotifopeningaudit.htm")

public class DataGridRedNotifOpeningAuditController extends ModuleController {

    private String moduleName = "datagridrednotifopeningaudit";
