 ...
 */
@Controller
@RequestMapping("/secure/datagridredocpaudit.htm")

public class DataGridRedOCPAuditController extends ModuleController {

    private String moduleName = "datagridredocpaudit";
