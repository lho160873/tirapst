 ...
 */
@Controller
@RequestMapping("/secure/datagridredofficedocaudit.htm")

public class DataGridRedOfficeDocAuditController extends ModuleController {

    private String moduleName = "datagridredofficedocaudit";
