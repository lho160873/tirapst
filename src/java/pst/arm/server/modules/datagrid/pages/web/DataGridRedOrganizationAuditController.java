 ...
 */
@Controller
@RequestMapping("/secure/datagridredorganizationaudit.htm")

public class DataGridRedOrganizationAuditController extends ModuleController {

    private String moduleName = "datagridredorganizationaudit";
