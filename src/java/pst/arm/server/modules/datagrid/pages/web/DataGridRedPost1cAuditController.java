 ...
 */
@Controller
@RequestMapping("/secure/datagridredpost1caudit.htm")

public class DataGridRedPost1cAuditController extends ModuleController {

    private String moduleName = "datagridredpost1caudit";
