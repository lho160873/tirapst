 ...
 */
@Controller
@RequestMapping("/secure/datagridredpostaudit.htm")

public class DataGridRedPostAuditController extends ModuleController {

    private String moduleName = "datagridredpostaudit";
