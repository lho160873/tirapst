 ...
 */
@Controller
@RequestMapping("/secure/datagridredpostworkeraudit.htm")

public class DataGridRedPostWorkerAuditController extends ModuleController {

    private String moduleName = "datagridredpostworkeraudit";
