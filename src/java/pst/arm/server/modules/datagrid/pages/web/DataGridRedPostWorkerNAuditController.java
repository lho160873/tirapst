 ...
 */
@Controller
@RequestMapping("/secure/datagridredpostworkernaudit.htm")

public class DataGridRedPostWorkerNAuditController extends ModuleController {

    private String moduleName = "datagridredpostworkernaudit";
