 ...
 */
@Controller
@RequestMapping("/secure/datagridredservcontractstageaudit.htm")

public class DataGridRedServContractStageAuditController extends ModuleController {

    private String moduleName = "datagridredservcontractstageaudit";
