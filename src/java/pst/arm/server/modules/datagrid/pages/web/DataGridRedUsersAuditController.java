 ...
 */
@Controller
@RequestMapping("/secure/datagridredusersaudit.htm")

public class DataGridRedUsersAuditController extends ModuleController {

    private String moduleName = "datagridredusersaudit";
