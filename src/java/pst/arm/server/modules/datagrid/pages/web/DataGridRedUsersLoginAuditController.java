 ...
 */
@Controller
@RequestMapping("/secure/datagridredusersloginaudit.htm")

public class DataGridRedUsersLoginAuditController extends ModuleController {

    private String moduleName = "datagridredusersloginaudit";
