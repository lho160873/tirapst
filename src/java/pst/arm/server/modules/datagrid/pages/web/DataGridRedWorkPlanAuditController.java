 ...
 */
@Controller
@RequestMapping("/secure/datagridredworkplanaudit.htm")

public class DataGridRedWorkPlanAuditController extends ModuleController {

    private String moduleName = "datagridredworkplanaudit";
