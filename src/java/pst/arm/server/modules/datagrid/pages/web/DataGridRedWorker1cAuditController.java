 ...
 */
@Controller
@RequestMapping("/secure/datagridredworker1caudit.htm")

public class DataGridRedWorker1cAuditController extends ModuleController {

    private String moduleName = "datagridredworker1caudit";
