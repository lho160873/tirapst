 ...
 */
@Controller
@RequestMapping("/secure/datagridredworkeraudit.htm")

public class DataGridRedWorkerAuditController extends ModuleController {

    private String moduleName = "datagridredworkeraudit";
