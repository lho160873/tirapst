 ...
 */
@Controller
@RequestMapping("/secure/datagridstorepartrestmart.htm")
public class DataGridStorePartRestMartController extends ModuleController {

    
    private String moduleName = "datagridstorepartrestmart";
