 ...
 */
@Controller
@RequestMapping("/secure/datagridstorepartrestpriboy.htm")
public class DataGridStorePartRestPriboyController extends ModuleController {

    
    private String moduleName = "datagridstorepartrestpriboy";
