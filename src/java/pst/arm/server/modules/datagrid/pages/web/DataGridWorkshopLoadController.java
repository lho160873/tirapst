 ...
 */
@Controller
@RequestMapping("/secure/datagridworkshopload.htm")
public class DataGridWorkshopLoadController extends ModuleController {

    
    private String moduleName = "datagridworkshopload";
