...
public class GanttChartPriboyDAOJdbcImpl extends JdbcDaoSupport implements GanttChartPriboyDAO {

    private static Logger log = Logger.getLogger("GanttChartPriboyDAOJdbcImpl");
...
//        log.warn("GanttChartPriboyDAOJdbcImpl::getAllOrders  = " + sql);
...
//        log.warn("GanttChartPriboyDAOJdbcImpl::getAllJobPlans  = " + sql);
...
//        log.warn("GanttChartPriboyDAOJdbcImpl::getAllJobs  = " + sql);
